    ...
    <div>
      {props.mode === "single" ? (
        <DayPicker
          ...
          className={cn("p-3 w-full [&_.rdp-table]:!grid [&_.rdp-table]:!grid-cols-7 [&_.rdp-row]:!grid [&_.rdp-row]:!grid-cols-7 [&_.rdp-cell]:!block [&_.rdp-day]:!block", className)}
          classNames={{
            ...
            cell: "h-9 w-9 text-center text-sm p-0 relative flex items-center justify-center flex-shrink-0 [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
            day: cn(
