  ...
  <div className="xl:grid xl:grid-cols-3 xl:gap-8">
    <div className="grid grid-cols-2 gap-8 xl:col-span-2">
      <div className="md:grid md:grid-cols-2 md:gap-8">
        {components.navigation.Footer.navigation.slice(0, 2).map((section, index) => (
          <div key={section.name} className={index === 1 ? 'mt-10 md:mt-0' : ''}>
            <h3 className="text-sm font-semibold leading-6 text-gray-900">{section.name}</h3>
            <ul role="list" className="mt-6 space-y-4">
              {section.links.map((link) => (
                <li key={link.name}>
                  <a href={`/${lang}${link.href}`} className="text-sm leading-6 text-gray-600 hover:text-gray-900">
                    {link.name}
                  </a>
                </li>
              ))}
      ...
      <div className="md:grid md:grid-cols-2 md:gap-8">
        {components.navigation.Footer.navigation.slice(2).map((section, index) => (
          <div key={section.name} className={index === 1 ? 'mt-10 md:mt-0' : ''}>
            <h3 className="text-sm font-semibold leading-6 text-gray-900">{section.name}</h3>
            <ul role="list" className="mt-6 space-y-4">
              {section.links.map((link) => (
    ...
    <div className="mt-10 xl:mt-0">
      <h3 className="text-sm font-semibold leading-6 text-gray-900">{footer.subscriptionCTA.headText}</h3>
      <p className="mt-2 text-sm leading-6 text-gray-600">{footer.subscriptionCTA.subText}</p>
