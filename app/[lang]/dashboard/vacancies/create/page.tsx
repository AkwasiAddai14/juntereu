...
import VacatureForm, { AIActions } from '@/app/[lang]/components/shared/forms/VacancyForm';
  ...
  return (
    ...
    <DashNav lang={lang} />
      <div className="wrapper my-8 px-4">
          ...
          <div className="flex justify-between items-center mx-12">
            <div>
              <h3 className="font-bold text-[28px] leading-[36px] md:text-[36px] md:leading-[44px] text-center sm:text-left">
                {dashboard?.Vacancies?.FormFieldItems?.[0] || 'Create Vacancy'}
              </h3>
              <p className="text-gray-600 mt-2">Fill out the form below to create a new vacancy</p>
            </div>
            <button
              type="button"
        ...
        <VacatureForm ref={formRef} userId={userId} type="maak" components={dashboard.components} validations={dashboard.Validations} />
      </div>
    <Footer lang={lang} />
    </>
  )
