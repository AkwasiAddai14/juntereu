...
export const VacancyValidation = z.object({
  ...
  function: z.string().min(1, 'Functie is verplicht'),
  ...
  dresscode: z.union([z.string(), z.array(z.string())]).optional(),
  surcharge: z.boolean(),
  surchargetype: z.number().optional(),
  surchargepercentage: z.number().optional(),
  surchargeVan: z.string().optional(),
  surchargeTot: z.string().optional(),
});
